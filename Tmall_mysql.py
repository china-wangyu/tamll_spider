...
class TmallMysql(object):
    ...
    def Table(self,table='ant_tmall_goods'):
        class Ant_tmall_goods(peewee.Model):
            ...
            goods_comment_num = peewee.CharField(max_length=100)
